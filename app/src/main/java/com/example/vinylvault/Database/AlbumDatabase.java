...
//    }
    ...
    public ArrayList<Album> getTopAlbums(int top){
        ...
        Cursor cursor = db.query(TABLE_ALBUM, new String[]{
                        COLUMN_ALBUM_ID, COLUMN_ALBUM_NAME, COLUMN_ALBUM_GENRE, COLUMN_ARTWORK, COLUMN_ALBUM_RATING, COLUMN_ALBUM_REVIEW }, null, null, null, null, COLUMN_ALBUM_RATING + " DESC", String.valueOf(top));
       while(cursor.moveToNext()) {
...
//
//        Cursor cursor = db.query(TABLE_ALBUM, new String[]{
//                        COLUMN_ALBUM_ID, COLUMN_ALBUM_NAME, COLUMN_ALBUM_GENRE, COLUMN_ARTWORK, COLUMN_ALBUM_RATING, COLUMN_ALBUM_REVIEW, COLUMN_ALBUM_STATUS},
//                COLUMN_ALBUM_GENRE + "=?",
